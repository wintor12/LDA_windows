...
//		    System.out.println(converged);
	...
	public static void run_em(Corpus corpus, int K)
	{	
		num_topics = K;
		...
		for(int d = 0; d < corpus.num_docs; d++)
		{
			...
			save_top_words(10, corpus.docs[d], path + "res_" + num_topics + "\\top_word\\" + corpus.docs[d].doc_name);
		}
