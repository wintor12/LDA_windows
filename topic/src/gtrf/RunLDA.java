...
public class RunLDA {
	...
	public static String perplexity = ""; //out put perplexity
...
//		    System.out.println(converged);
	...
	public static void run_em(Corpus corpus, int K, double l)
	{
		...
		for(int d = 0; d < corpus.num_docs; d++)
		{
			...
			save_top_words(10, corpus.docs[d], path + "res_" + num_topics + "_" + lambda2 + "\\top_word\\" + corpus.docs[d].doc_name);
		}
...
//			sb.append("\n");
		...
		perplexity += num_topics + " " + lambda2 + " " + perplex + "\n";
		try {
...
//    	RunLDA.run_em(corpus, 5, 0.4);
//    	RunLDA.run_em(corpus, 10, 0.4);
//    	RunLDA.run_em(corpus, 20, 0.4);
//    	RunLDA.run_em(corpus, 50, 0.4);
//    	RunLDA.run_em(corpus, 100, 0.4);
//    	RunLDA.run_em(corpus, 5, 0.6);
//    	RunLDA.run_em(corpus, 10, 0.6);
//    	RunLDA.run_em(corpus, 20, 0.6);
//    	RunLDA.run_em(corpus, 50, 0.6);
//    	RunLDA.run_em(corpus, 100, 0.6);
//    	RunLDA.run_em(corpus, 5, 0.8);
//    	RunLDA.run_em(corpus, 10, 0.8);
//    	RunLDA.run_em(corpus, 20, 0.8);
//    	RunLDA.run_em(corpus, 50, 0.8);
//    	RunLDA.run_em(corpus, 100, 0.8);
//    	try {
//			FileUtils.writeStringToFile(new File(path + "perplex_gtrf"),perplexity);
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
